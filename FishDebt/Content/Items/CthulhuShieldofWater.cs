...
namespace FishDebt.Content.Items
{
	...
	public class CthulhuShieldofWater : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Cthulu's Shield of Water");
			Tooltip.SetDefault("Wait a minute..." +
				"\nDouble tap in any horizontal direction to dash!");
		}
	...
	public class ExampleDashPlayer : ModPlayer
	{
		...
		public override void ResetEffects()
		{
			...
			for (int i = 3; i < 8 + Player.extraAccessorySlots; i++)
			{
				...
				if (item.type == ModContent.ItemType<CthulhuShieldofWater>())
