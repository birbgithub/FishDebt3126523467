...
{
    internal class jellyfishproj : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Feels sludgy...");
        ...
        {
            if (Collision.HitTiles(Projectile.position, Projectile.velocity, Projectile.width, Projectile.height));
...
namespace FishDebt.Content.Projectiles
{
	public class jellyfishproj : ModProjectile
	{
		...
		public override void SetDefaults()
		{
			...
			Projectile.aiStyle = 34; // The ai style of the projectile, please reference the source code of Terraria
		...
		public override bool OnTileCollide(Vector2 oldVelocity)
		{
			...
			else
			{
				...
				SoundEngine.PlaySound(SoundID.NPCHit43, Projectile.position);
